<section class="accomodation_area section_gap">
    <div class="container">
        <div class="section_title row">
                    <h2 class="title_color col-md-10">Formulaire d'<?= $_GET["type"] == 'edit' ? 'edition' : 'ajout' ?> Employe </h2>
                    <div class="col-md-2">
                           <a href="?page=employeAdmin" class="btn btn-success"><i class="fa fa-arrow-left"></i>Retour</a>
                    </div>            
         </div>
        ...
        <form action="" class="container" method="post" enctype="multipart/form-data">
            <div class="row">
               ...
               <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                 <label for="">Carte d'identite nationale <span class="text-danger">*</span></label>
                ...
                <div class="form-group col-md-6">
                   ...
                   <input type="text" name="email" value="<?= avoirInput("email",isset($e) ? $e :'') ?>" required class="form-control">
                </div>
