<section class="breadcrumb_area">
            ...
            <div class="container">
                <div class="page-cover text-center">
                    <h2 class="page-cover-tittle">Details Blog</h2>
                    <ol class="breadcrumb">
                        <li><a href="?page=blog">Blog</a></li>
                        <li class="active">Details Blog</li>
                    </ol>
                </div>
            </div>
        </section>
        ...
        <h1><?= $b->titre ?></h1> 
         <div class="row">
              <div class="feature-img col-md-8">
                   <img class="img-fluid" src="images/<?= $b->image ?>" style="width:100%;heigth:300px" alt=""><br>
                   <p class="mt-3"><?= $b->description ?></p>
              </div>
              <aside class="single_sidebar_widget popular_post_widget col-md-4">
                <h3 class="widget_title">Blogs recents</h3>
