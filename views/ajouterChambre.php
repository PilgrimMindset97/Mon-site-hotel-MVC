<section class="accomodation_area section_gap">
    <div class="container">
        <div class="section_title row">
                    ...
                    <div class="col-md-2">
                           <a href="?page=chambreAdmin" class="btn btn-success"><i class="fa fa-arrow-left"></i>Retour</a>
                    </div>            
         </div>
            ...
            <div class="row">
               <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-<?= isset($c) ? '12':'6' ?>">
                    ...
                    <textarea name="description" class="form-control" required><?= isset($c) ? $c->description : '' ?></textarea>
                </div>
                <?php if(isset($c)): ?>
                     <div class="col-md-6">
                         <img src="images/<?= $c->image ?>"  id="img_cible" witdh="400" heigth="100" alt="">
                     </div>
                 <?php endif; ?>   
                <div class="form-group col-md-6">
...
<script>
    document.getElementById("img").addEventListener("change",(event)=>{
        ...
        if (!file || !file.type.startsWith("image/")) {
            alert("Veillez selectionner une image");
            event.target.src = "";
            return;
        }
