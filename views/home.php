            ...
            <div class="booking_table d_flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<h6>Dans notre hôtel, nous nous engageons à offrir une expérience inégalée de luxe et de confort</h6>
						<h2>Reservez, detentez-vous et voyagez</h2>
						<p class="h5">Notre équipe dévouée s’efforce de dépasser les attentes, offrant un service exceptionnel, des équipements luxueux et un emplacement de choix.<br>Notre objectif est de créer des souvenirs inoubliables pour chaque client.</p>
						<a href="?page=reservation" class="btn theme_btn button_hover">Reservez</a>
					</div>
				</div>
            </div>
                   ...
                   <?php foreach($chambres as $key => $c): ?>
                       ...
                       <div class="col-lg-3 col-sm-6" id="<?= $c->id ?>">
                        <div class="accomodation_item text-center">
                            <div class="hotel_img">
                                <img src="images/<?= $c->image?>" heigth="50" width="250" alt="">
                                <?php if($c->statut==0): ?>
                ...
                <div class="row">
                    <div class="col-md-6 d_flex align-items-center">
                        <div class="about_content ">
                            ...
                            <a href="?page=register" class="button_hover theme_btn_two">Creer un compte</a>
                        </div>
                    </div>
                    <div class="col-md-6">
